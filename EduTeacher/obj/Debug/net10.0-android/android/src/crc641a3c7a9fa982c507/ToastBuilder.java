...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Controls.UserDialogs.Maui.ToastBuilder, Controls.UserDialogs.Maui", ToastBuilder.class, __md_methods);
	}

	public ToastBuilder ()
	{
		super ();
		if (getClass () == ToastBuilder.class) {
			mono.android.TypeManager.Activate ("Controls.UserDialogs.Maui.ToastBuilder, Controls.UserDialogs.Maui", "", this, new java.lang.Object[] {  });
		}
	}
