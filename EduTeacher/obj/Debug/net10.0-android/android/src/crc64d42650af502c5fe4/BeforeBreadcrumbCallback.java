...
/** @hide */
	...
	static {
		__md_methods = 
			"n_execute:(Lio/sentry/Breadcrumb;Lio/sentry/Hint;)Lio/sentry/Breadcrumb;:GetExecute_Lio_sentry_Breadcrumb_Lio_sentry_Hint_Handler:Sentry.JavaSdk.SentryOptions+IBeforeBreadcrumbCallbackInvoker, Sentry.Bindings.Android\n" +
			"";
